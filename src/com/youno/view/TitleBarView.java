package com.youno.view;

import com.youno.R;
import com.yunno.utils.SystemMethod;
...
public class TitleBarView extends RelativeLayout {
	...
	private LinearLayout title_search_box;
	...
	private void initView(){
		...
		title_search_box = (LinearLayout) findViewById(R.id.title_bar_serach);
		search_text = (TextView) findViewById(R.id.title_bar_serach_text);
	}
	...
	public void setCommonTitle(int LeftVisibility,int centerVisibility,int center1Visibilter,int center2Visibilter,int rightVisibility){
		btnLeft.setVisibility(LeftVisibility);
		btnRight.setVisibility(rightVisibility);
		tv_center.setVisibility(centerVisibility);
		common_constact.setVisibility(center1Visibilter);
		title_search_box.setVisibility(center2Visibilter);
	}
	
	
	
	public void setSearchBoxText(int txtRes){
		search_text.setText(txtRes);
	}
	
	public void setSearchBoxVisible(int searchBoxVisibility){
		title_search_box.setVisibility(searchBoxVisibility);
	}
	...
	public void setBtnLeft(int icon,String txt){
		Drawable img=mContext.getResources().getDrawable(icon);
		int height=SystemMethod.dip2px(mContext, 20);
		int width=img.getIntrinsicWidth()*height/img.getIntrinsicHeight();
		img.setBounds(0, 0, width, height);
	...
	public void setPopWindow(PopupWindow mPopWindow,TitleBarView titleBaarView){
			...
			setBtnRight(R.drawable.icon_head_home_scan);
		}
	...
	public void setSearchBoxOnclickListener(OnClickListener listener){
		title_search_box.setOnClickListener(listener);
	}
